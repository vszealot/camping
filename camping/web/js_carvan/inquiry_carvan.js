function inquiry_carvan(){
	$.ajax({
		type:"GET",
		url:"inquiry_carvanseq.do",
		error:function(){
			console.log("통신실패");
		},
		success:function(data){
			 var txt ="<div class='listTable'><table class='camptable'><tbody>"
					$.each(data, function(idx, val) {
						...
						txt += "<td style='width:320px;padding:5px;margin:5px;'><ul style='margin:0;padding:0;'><li><div class='campname'><a style='text-decoration:none;' href=\"javascript:abcd('"+val.x+"','"+val.y+"','"+val.campName+"','"+val.phone+"','"+val.addr1+"','"+val.addr2+"')\" onclick=\"w3_open()\">"+val.addr1+"</a><br></div></li>\r\n";
