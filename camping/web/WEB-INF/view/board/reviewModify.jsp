...
<body>
	...
	<div style="width: 50em;margin: 0 auto;">
		<form id="fr" name="fr" role="form" method="post" autocomplete="off" action="reviewUpdate.do" enctype="multipart/form-data">
...
<script>
	...
	$("#cancel_btn").click(function() {
		formObj.attr("action", "reviewRead.do?postNo=" + $("#postNo").val());
