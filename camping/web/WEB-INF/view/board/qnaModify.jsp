...
<body>
	...
	<div style="width: 50em;margin: 0 auto;">
		<form id="fr" name="fr" role="form" method="post" autocomplete="off" action="qnaUpdate.do" enctype="multipart/form-data">
...
<script>
	...
	$("#cancel_btn").click(function() {
		formObj.attr("action", "qnaRead.do?postNo=" + $("#postNo").val());
