...
<body>
	...
	<div style="width: 50em;margin: 0 auto;">
		<form id="fr" name="fr" role="form" method="post" autocomplete="off" action="qnaInsert.do" enctype="multipart/form-data">
			...
			<div style="text-align: center;">
				...
				<a role="button" href="qnaListSearch.do" class="btn btn-default">취소</a>
			</div>
		</form>
		</div>
	</section>
