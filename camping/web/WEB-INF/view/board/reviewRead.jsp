...
<body id="body1">
	...
	<table role="form"></table>
		<form role="form" method="post" autocomplete="off" action="reviewInsert.do" enctype="multipart/form-data">
			...
			<table class="table">
				...
				<tr>
					<td style="height: 200px;" colspan="3">
						...
						<p style="white-space:pre;"><c:out value="${read.content}"/></p>
					</td>
				</tr>
				<tr>
					<td colspan="3">
...
<script>
	...
	$("#list_btn").click(function() {
		formObj.attr("action", "reviewListSearch.do");
	...
	$("#modify_btn").click(function() {
		formObj.attr("action", "reviewModify.do");
		formObj.attr("method", "post");
		formObj.submit();
	...
	$("#delete_btn").click(function() {
		if (confirm("삭제하시겠습니까?")) {
			formObj.attr("action", "reviewDelete.do");
			formObj.attr("method", "post");
			formObj.submit();
		}else{
			formObj.attr("action", "reviewRead.do");
			formObj.attr("method", "post");
			formObj.submit();
		}
	});
